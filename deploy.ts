...
async function handleRequest(request: Request): Promise<Response> {
  ...
  if (url.pathname === "/" || url.pathname === "/index.html") {
    const response = await fetch("https://raw.githubusercontent.com/Ntristen49/website/main/index.html?v=512214321312");
  ...
  if (url.pathname === "/css/app.f55877a1.css") {
    const response = await fetch("https://raw.githubusercontent.com/RealVindict/website/main/app.f55877a1.css");
  ...
  if (url.pathname === "/css/838.35daa32b.css") {
    const response = await fetch("https://raw.githubusercontent.com/RealVindict/website/main/838.35daa32b.css");
    const headers = new Headers({ "content-type": "text/css" });
    return new Response(await response.text(), { headers });
  }
  ...
  if (url.pathname === "/img/logo.0d11fe46.png") {
    const response = await fetch("https://raw.githubusercontent.com/RealVindict/website/main/logo.0d11fe46.png");
  ...
  if (url.pathname === "/favicon.ico") {
    const response = await fetch("https://raw.githubusercontent.com/RealVindict/website/main/favicon.ico");
